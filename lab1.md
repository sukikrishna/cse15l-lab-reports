...
- **cat /home/linux/ieng6/cs15lwi23/public/hello.txt** - will read out or print to the screen the text that is located within a particular text file
- **mkdir** - will create a directory within your current directory
